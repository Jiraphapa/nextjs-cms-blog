    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
            ...
            <h1 className='transition duration-700 text-center mb-8 cursor-pointer
                hover:text-orange-600 text-3xl font-semibold
            '>
            ...
            <div className="text-center">
                <Link href={`/post/${post.slug}`}>
                    <span className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-orange-600 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Continue Reading</span>
                </Link>
            </div>
        </div>
    )
